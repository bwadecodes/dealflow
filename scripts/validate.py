...
EXPECTED_FILES = [
    ...
    "config/defaults/pe-middle-market.yaml",
    "config/defaults/pe-large-buyout.yaml",
    "config/defaults/venture-capital.yaml",
    "config/defaults/growth-equity.yaml",
    "config/example-config.yaml",
    "dealflow-setup/SKILL.md",
    "dealflow-firmstyle/SKILL.md",
    "dealflow-prescreen/SKILL.md",
    "dealflow-deskresearch/SKILL.md",
    "dealflow-dataroom/SKILL.md",
    "dealflow-model/SKILL.md",
    "dealflow-questions/SKILL.md",
    "dealflow-superanalyst/SKILL.md",
    "dealflow-cohort/SKILL.md",
    "dealflow-vp-review/SKILL.md",
    "dealflow-pre-ic/SKILL.md",
    "dealflow-process/SKILL.md",
    "dealflow-checklist/SKILL.md",
    "dealflow-returns/SKILL.md",
